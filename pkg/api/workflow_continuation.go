...
const (
	...
	// UploadSkipReasonDescriptionFailed means the tracker requires a
	// description and the retained outcome is missing or did not complete, so
	// the upload plan blocks the tracker.
	UploadSkipReasonDescriptionFailed UploadSkipReason = "description_failed"
	// UploadSkipReasonUploadPreparationFailed means the retained dry-run report
	// did not produce a ready tracker operation.
	UploadSkipReasonUploadPreparationFailed UploadSkipReason = "upload_preparation_failed"
	// UploadSkipReasonUploadPreparationSkipped means the retained dry-run report
	// skipped the tracker, for example when its torrent would require rehashing.
	UploadSkipReasonUploadPreparationSkipped UploadSkipReason = "upload_preparation_skipped"
)
