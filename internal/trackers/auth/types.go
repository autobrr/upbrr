...
// Package auth manages tracker login, cookie import, session validation,
...
type AuthRequiredError struct { //nolint:revive // Preserve the established cross-package API during package relocation.
	TrackerID string
	Reason    string
	Err       error
}
