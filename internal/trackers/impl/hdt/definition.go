...
// Definition provides HDT tracker preparation and optional policy capabilities.
type Definition struct{}

// New returns a fresh HDT tracker definition.
func New() *Definition { return &Definition{} }

// Name returns the stable HDT tracker identifier.
func (Definition) Name() string {
	return "HDT"
}

// Prepare builds a fresh intent-scoped HDT tracker plan.
