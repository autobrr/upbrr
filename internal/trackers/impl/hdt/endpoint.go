...
func (Definition) DefaultBaseURL() string { return "https://hd-torrents.me" }
...
func (Definition) TorrentIdentityPolicy() *trackers.TorrentIdentityPolicy {
	return &trackers.TorrentIdentityPolicy{TrackerURLPatterns: []string{"https://hdts-announce.ru"}}
}
