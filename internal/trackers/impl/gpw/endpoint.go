...
func (Definition) DefaultBaseURL() string { return "https://greatposterwall.com" }
...
func (Definition) TorrentIdentityPolicy() *trackers.TorrentIdentityPolicy {
	return &trackers.TorrentIdentityPolicy{TrackerURLPatterns: []string{"https://tracker.greatposterwall.com"}}
}
