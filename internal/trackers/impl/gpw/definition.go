...
// Definition provides GPW tracker preparation and optional policy capabilities.
type Definition struct{}

// New returns a fresh GPW tracker definition.
func New() *Definition { return &Definition{} }

// Name returns the stable GPW tracker identifier.
func (Definition) Name() string {
	return "GPW"
}

// Prepare builds a fresh intent-scoped GPW tracker plan.
