...
func (Definition) DefaultBaseURL() string { return "https://filelist.io" }
...
func (Definition) TorrentIdentityPolicy() *trackers.TorrentIdentityPolicy {
	return &trackers.TorrentIdentityPolicy{TrackerURLPatterns: []string{"reactor.filelist", "reactor.thefl.org"}}
}
