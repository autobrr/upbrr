...
// Definition provides FL tracker preparation and optional policy capabilities.
type Definition struct{}

// New returns a fresh FL tracker definition.
func New() *Definition { return &Definition{} }

// Name returns the stable FL tracker identifier.
func (Definition) Name() string {
	return "FL"
}

// Prepare builds a fresh intent-scoped FL tracker plan.
