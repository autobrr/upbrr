...
// Definition provides BJS tracker preparation and optional policy capabilities.
type Definition struct{}

// New returns a fresh BJS tracker definition.
func New() *Definition { return &Definition{} }

// Name returns the stable BJS tracker identifier.
func (Definition) Name() string {
	return "BJS"
}

// Prepare builds a fresh intent-scoped BJS tracker plan.
