...
func (Definition) DefaultBaseURL() string { return "https://speedapp.io" }
...
func (Definition) TorrentIdentityPolicy() *trackers.TorrentIdentityPolicy {
	return &trackers.TorrentIdentityPolicy{TrackerURLPatterns: []string{"ramjet.speedapp.io", "ramjet.speedapp.to", "ramjet.speedappio.org"}}
}
