...
func (*Definition) DefaultBaseURL() string { return "https://cliente.amigos-share.club" }
...
func (*Definition) TorrentIdentityPolicy() *trackers.TorrentIdentityPolicy {
	return &trackers.TorrentIdentityPolicy{TrackerURLPatterns: []string{"amigos-share.club"}}
}
