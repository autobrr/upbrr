...
// Definition provides IS tracker preparation and optional policy capabilities.
type Definition struct{}

// New returns a fresh IS tracker definition.
func New() *Definition { return &Definition{} }

// Name returns the stable IS tracker identifier.
func (Definition) Name() string {
	return "IS"
}

// Prepare builds a fresh intent-scoped IS tracker plan.
