...
func (Definition) DefaultBaseURL() string { return "https://immortalseed.me" }
...
func (Definition) TorrentIdentityPolicy() *trackers.TorrentIdentityPolicy {
	return &trackers.TorrentIdentityPolicy{TrackerURLPatterns: []string{"https://immortalseed.me"}}
}
