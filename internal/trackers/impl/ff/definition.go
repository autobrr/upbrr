...
// Definition provides FF tracker preparation and optional policy capabilities.
type Definition struct{}

// New returns a fresh FF tracker definition.
func New() *Definition { return &Definition{} }

// Name returns the stable FF tracker identifier.
func (Definition) Name() string {
	return "FF"
}

// Prepare builds a fresh intent-scoped FF tracker plan.
