...
// Definition provides DC tracker preparation and optional policy capabilities.
type Definition struct{}

// New returns a fresh DC tracker definition.
func New() *Definition { return &Definition{} }

// Name returns the stable DC tracker identifier.
func (Definition) Name() string {
	return "DC"
}

// Prepare builds a fresh intent-scoped DC tracker plan.
