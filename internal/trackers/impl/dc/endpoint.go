...
func (Definition) DefaultBaseURL() string { return "https://digitalcore.club" }
...
func (Definition) TorrentIdentityPolicy() *trackers.TorrentIdentityPolicy {
	return &trackers.TorrentIdentityPolicy{TrackerURLPatterns: []string{"tracker.digitalcore.club", "trackerprxy.digitalcore.club"}}
}
