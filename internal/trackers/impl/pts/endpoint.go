...
func (Definition) DefaultBaseURL() string { return "https://www.ptskit.org" }
...
func (Definition) TorrentIdentityPolicy() *trackers.TorrentIdentityPolicy {
	return &trackers.TorrentIdentityPolicy{TrackerURLPatterns: []string{"https://tracker.ptskit.com"}}
}
