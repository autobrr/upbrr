...
// Definition provides BT tracker preparation and optional policy capabilities.
type Definition struct{}

// New returns a fresh BT tracker definition.
func New() *Definition { return &Definition{} }

// Name returns the stable BT tracker identifier.
func (Definition) Name() string {
	return "BT"
}

// Prepare builds a fresh intent-scoped BT tracker plan.
