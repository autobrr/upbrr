...
func TestInjectUnsupportedType(t *testing.T) {
	...
	err := svc.Inject(context.Background(), api.ClientSubject{SourcePath: "video.mkv"}, api.TorrentResult{Path: "/tmp/file.torrent"})
...
func TestQbitAutomaticManagementEnabledUsesPathBoundaries(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			meta := api.ClientSubject{SourcePath: tt.sourcePath}
...
func TestInjectQbitClientIgnoresCrossFieldsForNormalTorrent(t *testing.T) {
	...
	if err := svc.Inject(context.Background(), api.ClientSubject{SourcePath: "video.mkv"}, api.TorrentResult{Path: torrentPath, Tracker: "AITHER"}); err != nil {
		t.Fatalf("inject: %v", err)
	}
...
func TestInjectQbitClientUsesCrossFieldsForCrossSeedTorrent(t *testing.T) {
	...
	if err := svc.Inject(context.Background(), api.ClientSubject{SourcePath: "video.mkv"}, api.TorrentResult{
		Path:      torrentPath,
		Tracker:   "AITHER",
		CrossSeed: true,
	}); err != nil {
...
func TestInjectQbitClientCleansStagingAfterLoginFailure(t *testing.T) {
	...
	err := svc.Inject(context.Background(), api.ClientSubject{SourcePath: source, FileList: []string{source}}, api.TorrentResult{Path: torrentPath, Tracker: "EXAMPLE"})
	if err == nil {
...
func TestInjectQbitClientURLLinkingFallsBackWithoutStaging(t *testing.T) {
	...
	if err := svc.Inject(context.Background(), api.ClientSubject{SourcePath: source, FileList: []string{source}}, api.TorrentResult{URL: "https://tracker.example/torrent/1", Tracker: "AITHER"}); err != nil {
...
func TestInjectQbitClientInvalidLinkPlanFallbackSkipsHashCheck(t *testing.T) {
	...
	err := svc.Inject(context.Background(), api.ClientSubject{
		SourcePath: source,
...
func TestInjectQbitClientRejectsUnsafeTrackerLinkDirName(t *testing.T) {
	...
	err := svc.Inject(context.Background(), api.ClientSubject{SourcePath: source, FileList: []string{source}}, api.TorrentResult{Path: torrentPath, Tracker: "AITHER"})
...
func TestInjectQbitClientFailedLinkPlanFallbackSkipsHashCheck(t *testing.T) {
	...
	if err := svc.Inject(context.Background(), api.ClientSubject{SourcePath: source, FileList: []string{source}}, api.TorrentResult{Path: torrentPath, Tracker: "EXAMPLE"}); err != nil {
...
func TestInjectQbitClientAllowsMatchingExistingHardlinkDest(t *testing.T) {
	...
	if err := svc.Inject(context.Background(), api.ClientSubject{SourcePath: source, FileList: []string{source}}, api.TorrentResult{Path: torrentPath, Tracker: "AITHER"}); err != nil {
		t.Fatalf("inject: %v", err)
	}
	select {
	case err := <-capture.errCh:
...
func TestInjectQbitClientReflinksSourceAndUsesLinkedSavePath(t *testing.T) {
	...
	meta := api.ClientSubject{SourcePath: source}
	if err := svc.Inject(context.Background(), meta, api.TorrentResult{Path: torrentPath, Tracker: "AITHER"}); err != nil {
		t.Fatalf("inject: %v", err)
	}
...
func TestInjectUsesTrackerTorrentClient(t *testing.T) {
	...
	meta := api.ClientSubject{SourcePath: "video.mkv"}
	if err := svc.Inject(context.Background(), meta, api.TorrentResult{Path: torrentPath, Tracker: "aither"}); err != nil {
		t.Fatalf("inject: %v", err)
	}
...
func TestInjectTrackerTorrentClientURLOnlyWatchReturnsErrorWithoutFallback(t *testing.T) {
	...
	err := svc.Inject(context.Background(), api.ClientSubject{SourcePath: "video.mkv"}, api.TorrentResult{
...
func TestInjectDisabledClient(t *testing.T) {
	...
	if err := svc.Inject(context.Background(), api.ClientSubject{SourcePath: "video.mkv"}, api.TorrentResult{Path: "/tmp/file.torrent"}); err != nil {
...
func TestInjectQbitClientFromURL(t *testing.T) {
	...
	if err := svc.Inject(context.Background(), api.ClientSubject{SourcePath: "video.mkv"}, api.TorrentResult{URL: injectURL, Tracker: "AITHER"}); err != nil {
		t.Fatalf("inject: %v", err)
	}
...
func TestInjectURLSkipsWatchFolderClient(t *testing.T) {
	...
	if err := svc.Inject(context.Background(), api.ClientSubject{SourcePath: "video.mkv"}, api.TorrentResult{URL: "https://aither.cc/torrent/download/374352.382"}); err != nil {
		t.Fatalf("inject: %v", err)
	}
...
func TestInjectURLFallbackSkipsWatchBeforeDelay(t *testing.T) {
	...
	err := svc.Inject(ctx, api.ClientSubject{SourcePath: "video.mkv"}, api.TorrentResult{URL: "https://aither.cc/torrent/download/374352.382"})
	if err != nil {
		t.Fatalf("inject: %v", err)
	}
...
func TestInjectHonorsGlobalDelayCancellation(t *testing.T) {
	...
	err := svc.Inject(ctx, api.ClientSubject{SourcePath: "video.mkv"}, api.TorrentResult{URL: "https://tracker.example/download/1", Tracker: "AITHER"})
...
func TestInjectTrackerDelayOverrideBeatsGlobalDelay(t *testing.T) {
	...
	if err := svc.Inject(ctx, api.ClientSubject{SourcePath: "video.mkv"}, api.TorrentResult{URL: "https://tracker.example/download/1", Tracker: "aither"}); err != nil {
		t.Fatalf("inject: %v", err)
	}
	if !addCalled {
