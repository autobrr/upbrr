...
func TestIsRenamedRelease(t *testing.T) {
	...
	grouped := func(sourcePath string) ModifiedReleaseSubject {
		return ModifiedReleaseSubject{
	...
	cases := []struct {
		...
		},
		{
			...
			meta: ModifiedReleaseSubject{SourcePath: "/data/movies/Some Home Video 2024"},
			want: false,
		},
		{
		...
		},
		{
			...
			meta: func() ModifiedReleaseSubject {
